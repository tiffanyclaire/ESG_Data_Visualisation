        ...
        <Row className="mt-2">
          <Col md={8} className="text-start">
            <p>
              ...
              which manufacture and sell firearms within the civilian market.
            </p>
            <h6>
        ...
        <Container className="mb-5">
          <Row className="mb-3 , justify-content-md-center">
            <Col md={8} className="text-start">
              ...
              <p>
                Data on companies which manufacture firearms for the civilian
                market (non-military use) is from Morningstar. Support for
                increased background checks has increased, however it is still
                possible to be unknowlingly investing in the firearms industry.{" "}
              </p>
            </Col>
          </Row>
          ...
          <Row className="mb-3 , justify-content-md-center">
            <Col md={8} className="text-start">
              ...
              <p>
                The gun manufacturers screen is comprised of publicly traded
                companies identified as manufacturers of firearms or ammunition.
              </p>
            </Col>
          </Row>
          ...
          <Row className="mb-3 , justify-content-md-center">
            <Col md={8} className="text-start">
              ...
              <p>
                The gun retailers screen is comprised of publicly traded
                companies identified as retailers of firearms or ammunition for
                the civilian market. Billions are made through sales in
                handguns, shotguns, rifles, ammunition and semiautomatic
                weapons.
              </p>
            </Col>
          </Row>
