        ...
        <Row className="mt-2">
          <Col lg={8} className="text-start">
            <p>
              ...
              which produce tobacco or promote to children.
            </p>
            <h6>
        ...
        <Container className="mb-5">
          <Row className="mb-3 , justify-content-md-center">
            <Col md={8} className="text-start">
              ...
              <p>
                Identified using Morningstar industry categories, these
                companies either produce or manufacture tobacco products.{" "}
              </p>
            </Col>
          </Row>
          ...
          <Row className="mb-3 , justify-content-md-center">
            <Col md={8} className="text-start">
              ...
              <p>
                Around the world tobacoo promotion to young audiences has been
                banned. Tobacco depiction policies are in place in some
                countries, however some video production companies and studios
                have not eliminated smoking in PG-13 films. The
                tobacco-promoting entertainment companies screen is comprised of
                companies identified by UCSF's Smoke Free Films campaign
              </p>
            </Col>
          </Row>
        </Container>
