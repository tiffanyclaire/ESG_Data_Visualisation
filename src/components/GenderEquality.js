...
function GenderEquality({ data, names }) {
  ...
  const genderTransparency = {
    ...
    datasets: [
      {
        label:
          "Commitment, transparency, and accountability (out of 10 points)",
        data: transparency,
        backgroundColor: ["rgba(0, 151, 255, 0.6)"],
      },
    ],
        ...
        <Container className="mb-3">
          <Row>
            <Col md={8} className="text-start">
              <h4 className="mb-3">
                Holdings with Equileap gender equality scores
              </h4>
              <p>
                Below represents the percent of fund assets where Equileap
                gender equality company scores are available for each of the
                funds you invest in.
              </p>
            </Col>
          </Row>
        ...
        <Container className="mb-3">
          <Row>
            <Col md={8} className="text-start">
              ...
              <p>
                The gender equality score for gender balance in leadership and
                workforce is calculated by averaging the Equileap company scores
                of the portfolio holdings, weighted by market value
              </p>
            </Col>
          </Row>
        </Container>
        ...
        <Container className="mb-3">
          <Row className="mb-3">
            <Col md={8} className="text-start">
              ...
              <p>
                The gender equality score for equal compensation and work life
                balance is calculated by averaging the Equileap company scores
                of the portfolio holdings, weighted by market value
              </p>
            </Col>
          </Row>
        ...
        <Container className="mb-3">
          <Row className="mb-3">
            <Col md={8} className="text-start">
              ...
              <p>
                The gender equality score for policies promoting gender equality
                is calculated by averaging the Equileap company scores of the
                portfolio holdings, weighted by market value.
              </p>
            </Col>
          </Row>
        </Container>
        ...
        <Container className="mb-3">
          <Row className="mb-3">
            <Col md={8} className="text-start">
              ...
              <p>
                The gender equality score for commitment, transparency, and
                accountability is calculated by averaging the Equileap company
                scores of the portfolio holdings, weighted by market value.
              </p>
            </Col>
          </Row>
        </Container>
