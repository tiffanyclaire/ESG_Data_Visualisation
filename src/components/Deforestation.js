        ...
        <Row className="mt-2">
          <Col lg={8} className="text-start">
            <p className="text-start">
              ...
              which fund deforestation-risk producers, sell resources from
              unsustainable producers, or contribute to deforestation directly.
            </p>
            <h6>
            ...
            <h6 className="text-start">
              This data was collected between 1tst August 2022 and 31st August
              2022{" "}
            </h6>
          </Col>
        </Row>
        ...
        <Container className="mb-5">
          <Row className="mb-3 , justify-content-md-center">
            <Col md={8} className="text-start">
              ...
              <p>
                Consumer goods retailers that source palm oil, paper/pulp,
                rubber, timber, cattle, and soy from deforestation-risk
                producers and traders and sell it to consumers worldwide.
              </p>
            </Col>
          </Row>
          ...
          <Row className="mb-3 , justify-content-md-center">
            <Col md={8} className="text-start">
              ...
              <p>
                Companies that produce and trade palm oil, paper/pulp, rubber,
                timber, cattle, and soy, and have a past record or a significant
                risk of contributing to deforestation, land grabbing, and human
                rights abuses.
              </p>
            </Col>
          </Row>
          ...
          <Row className="mb-3 , justify-content-md-center">
            <Col md={8} className="text-start">
              ...
              <p>
                Financial institutions directly and indirectly involved in
                underwriting and lending to deforestation-risk producers and
                traders. These are the publicly listed banks drawn from the
                platform Forests and Finance.
              </p>
            </Col>
          </Row>
        </Container>
